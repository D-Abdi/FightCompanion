...
@section('content')
    <div id="container" style="font-family:Verdana,sans-serif">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="" style="text-align:center;font-size: x-large">Edit Your Profile</h1>
                <div class="card-body">
                    <form  method="post" action="/profile/{{$attribute->id}}"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file"
                                       ...
                                       value="{{$attribute->profile_picture}}"
                                       required>
